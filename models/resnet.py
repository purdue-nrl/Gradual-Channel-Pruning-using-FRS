...
class ResNet(nn.Module):
    def __init__(self, block, num_blocks, n=1, num_classes=10):
        ...
        self.fc = MaskedLinear(512*block.expansion*n*n, num_classes)
...
def ResNet18(n=1, num_classes=10):
    return ResNet(BasicBlock, [2,2,2,2], n, num_classes)

def ResNet34(n=1, num_classes=10):
    return ResNet(BasicBlock, [3,4,6,3], n, num_classes)

def ResNet50(n=1, num_classes=100):
    return ResNet(Bottleneck, [3,4,6,3],n, num_classes)
